...
class UserApi extends AbstractApi
{
    ...
    public function findAll(array $query = []): array
    {
        ...
        $json = $this->sendRequest('GET', 'users' . ($params ? "?{$params}" : ''))
            ->getBody()
            ->getContents();
    ...
    {
        return (int)$this->sendRequest('GET', 'users/count')
            ->getBody()
            ->getContents();
    }
    ...
    {
        $res = $this->sendRequest('POST', 'users', $newUser);
    ...
    {
        $this->sendRequest('PUT', "users/{$user->id}", $user);
    }
    ...
    public function resetPassword(string $id, string $newPassword, bool $temporary = false): void
    {
        ...
        $this->sendRequest('PUT', "users/$id/reset-password", $passwordReset);
    }
    ...
    {
        $roleJson = $this->sendRequest('GET', "users/$id/role-mappings")
            ->getBody()
            ->getContents();
    ...
    {
        $realmRolesJson = $this->sendRequest('GET', "users/$id/role-mappings/realm")
            ->getBody()
            ->getContents();
    ...
    {
        $realmRolesJson = $this->sendRequest('GET', "users/$id/role-mappings/realm/available")
            ->getBody()
            ->getContents();
    ...
    {
        $clientRolesJson = $this->sendRequest('GET', "users/$id/role-mappings/clients/$clientId")
            ->getBody()
            ->getContents();
    ...
    {
        $clientRolesJson = $this->sendRequest('GET', "users/$id/role-mappings/clients/$clientId/available")
            ->getBody()
            ->getContents();
    ...
    {
        $requiredActionsJson = $this->sendRequest('GET', 'authentication/required-actions')
            ->getBody()
            ->getContents();
    ...
    {
        $credentialsJson = $this->sendRequest('GET', "users/$id/credentials")
            ->getBody()
            ->getContents();

        return array_map(
            static function ($credentialsArr): Credential {
    ...
    {
        $this->sendRequest('DELETE', "users/$id/credentials/$credentialId");
    }
}
